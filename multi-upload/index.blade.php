    ...
    <div class="box">
      ...
      <div class="box-body">
        <p>
          ...
          manager. Users can drop an entire directory tree or pick a folder: it is zipped in the browser,
          uploaded as a single archive, extracted by Wings and the archive is deleted automatically, keeping
    ...
    <div class="box">
      ...
      <div class="box-body">
        <ul style="margin-bottom: 0; padding-left: 18px;">
          <li>Dropped or picked folders are zipped client-side (native <code>CompressionStream</code>, no libraries).</li>
